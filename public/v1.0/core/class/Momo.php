...
class Momo
{
    ...
    private $URLAction = array(
        ...
        "TRANS_ID_HISTORY"                     => "https://api.momo.vn/transhis/api/transhis/detail", //check nội dung giao dịch
    );
	
	private $vsignAPIKey = 'f0d9076331384303b8b27bb3d46f11c3';
    ...
    public function CHECK_USER_BE_MSG()
    {
        ...
        $header = array(
			...
			'user_phone: ',
			'app_code: 4.1.9',
			'vsign: ',
			'user-agent: MoMoPlatform Store/4.1.9.41094 CFNetwork/1335.0.3.4 Darwin/21.6.0 (iPhone 13 iOS/17.1) AgentID/0',
			'app_version: 41094',
			'tbid: 7FB59D25BB29C0A298519DC4E68D8679A9EAF88C',
			'lang: vi',
			'channel: APP',
			'momo-session-key-tracking: 9B9970D4-A3E8-4D68-A5AD-046320B706FE',
			'vversion: 1004',
			'env: production',
			...
			'agent_id: 0',
			'content-type: application/json',
			'platform-timestamp: 1700035529123'
        );
    ...
    public function REG_DEVICE_MSG()
    {
        ...
        $header = array(
			...
			'user_phone: ',
			'app_code: 4.1.9',
			'vsign: ',
			'user-agent: MoMoPlatform Store/4.1.9.41094 CFNetwork/1335.0.3.4 Darwin/21.6.0 (iPhone 13 iOS/17.1) AgentID/0',
			'app_version: 41094',
			'tbid: 7FB59D25BB29C0A298519DC4E68D8679A9EAF88C',
			'lang: vi',
        ...
        $Data = array(
            ...
            'extra'=> array(
              ...
              'SECUREID'=> '',
              'MODELID'=> $this->config['MODELID'],
              'DEVICE_TOKEN'=> '1FE9314935A421104D70E346CDF9EF4D8087DD8E7407C89D07C338A02DB7316C',
				'isAllowNoti'=> 'true'
            ));
    ...
    public function SEND_OTP_MSG()
    {
		...
		// Khai báo các biến và giá trị từ $this->config
		$user = $this->config["phone"];
		$imei = $this->config["imei"];
		...
		// Tạo mảng dữ liệu cho yêu cầu
		$data = ["user" => $user,"msgType" => "SEND_OTP_MSG","momoMsg" => ["_class" => "mservice.backend.entity.msg.RegDeviceMsg","number" => $user,"imei" => $imei,"cname" => "Vietnam","ccode" => "084","device" => "iPhone 7","firmware" => "17.1","hardware" => "iPhone","manufacture" => "Apple","csp" => "Viettel","icc" => "","mcc" => "452","mnc" => "04","device_os" => "ios","secure_id" => ""],"extra" => ["action" => "SEND","rkey" => $rkey,"AAID" => $AAID,"IDFA" => "","SIMULATOR" => false,"TOKEN" => $TOKEN,"ONESIGNAL_TOKEN" => $TOKEN,"SECUREID" => "","MODELID" => $MODELID,"DEVICE_TOKEN" => "1FE9314935A421104D70E346CDF9EF4D8087DD8E7407C89D07C338A02DB7316C","isVoice" => true,"OTP_TYPE" => "","REQUIRE_HASH_STRING_OTP" => true],"appVer" => 41094,"appCode" => "4.1.9","lang" => "vi","deviceOS" => "ios","channel" => "APP","buildNumber" => 0,"appId" => "vn.momo.platform","cmdId" => (string)$microtime . "000000","time" => $microtime];


		$dataJson = '{"user":"0947773373","msgType":"SEND_OTP_MSG","momoMsg":{"_class":"mservice.backend.entity.msg.RegDeviceMsg","number":"0947773373","imei":"BD1FA456-D788-452C-82FE-064D84C44392","cname":"Vietnam","ccode":"084","device":"iPhone 7","firmware":"17.1","hardware":"iPhone","manufacture":"Apple","csp":"Viettel","icc":"","mcc":"452","mnc":"04","device_os":"ios","secure_id":""},"extra":{"action":"SEND","rkey":"S2ew8DvaT9NsONXg9fDM","IDFA":"","SIMULATOR":false,"TOKEN":"e9guelH7dnU:APA91bEShME4zHz3Pbf70mcHifUWgHxRgXK3AMTW3ufxgS51eReN69yl06TtKL3Szt9zjwtNekAQrGSjoOFBJetsPn56KwqGmV02CbSspcvXuHiCSHSt3ZwebkBk0TzQEbX1ml3S6P4k","ONESIGNAL_TOKEN":"e9guelH7dnU:APA91bEShME4zHz3Pbf70mcHifUWgHxRgXK3AMTW3ufxgS51eReN69yl06TtKL3Szt9zjwtNekAQrGSjoOFBJetsPn56KwqGmV02CbSspcvXuHiCSHSt3ZwebkBk0TzQEbX1ml3S6P4k","SECUREID":"","MODELID":"34de256c1eb5dc2e0cd774a190cf2327351b91711b7525c9c9e768334d8c7f4c","DEVICE_TOKEN":"1FE9314935A421104D70E346CDF9EF4D8087DD8E7407C89D07C338A02DB7316C","isVoice":true,"OTP_TYPE":"","REQUIRE_HASH_STRING_OTP":true},"appVer":41094,"appCode":"4.1.9","lang":"vi","deviceOS":"ios","channel":"APP","buildNumber":0,"appId":"vn.momo.platform","cmdId":"1700036044123000000","time":1700036044123}';

		curl_setopt_array($curl, array(
			CURLOPT_URL => 'https://api.momo.vn/backend/otp-app/public/SEND_OTP_MSG',
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_ENCODING => '',
			...
			CURLOPT_HTTPHEADER => array(
				...
				'agent_id: 0',
				'content-type: application/json',
				'platform-timestamp: ' . $microtime // Thay thế giá trị thời gian
			),
		));
