...
class MBBANK
{
    ...
    public function login($captcha)
    {
        $header = array(
            ...
            'X-Request-Id: 7ed665bc35bb47f19b263447bd1cc180-2022090511445886',
			 'Refno: MINBIBO-2024012616251659',
    'Deviceid: jkhws0k4-mbib-0000-0000-2024012616225817',
        );
        $Action = 'https://online.mbbank.com.vn/api/retail_web/internetbanking/doLogin';
        $Data = '{
            "password" : "' . md5($this->pass) . '",
            "refNo" : "' . md5($this->user) . '-2024012616251659",
            "sessionId" : null,
            "userId" : "' . $this->user . '",
            "captcha" : "' . $captcha . '",
    ...
    'Deviceid: jkhws0k4-mbib-0000-0000-2024012616225817',
        ...
        $Action = 'https://online.mbbank.com.vn/api/retail-web-internetbankingms/getCaptchaImage';
        $Data = '{
    ...
    'Deviceid: jkhws0k4-mbib-0000-0000-2024012616225817',
        ...
        $Action = 'https://online.mbbank.com.vn/api/retail-web-accountms/getBalance';
        $Data = '{
