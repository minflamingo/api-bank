                    ...
                    <div class="card card-dark card-tabs">
                        <div class="card-header p-0 pt-1 border-bottom-0">
                            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="pill" href="#tab3" role="tab" aria-controls="custom-tabs-three-profile" aria-selected="false">AUTO BANK</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="author" value="<?= $NNL->site('author') ?>" placeholder="VD: Đinh Việt Cường">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">API KEY CAPTCHA
                                                    </label>
                                                    <input type="text" class="form-control" name="key_captcha" value="<?= $NNL->site('key_captcha') ?>">
                                                    <i>ECAPTCHA.SIEUTHICODE.NET</i>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                ...
                                <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3">
                                    <form action="" method="POST">
										...
										<div class="form-group">
                                            <label for="exampleInputEmail1">Token VCB</label>
                                            <input type="text" class="form-control" name="token_vcb" value="<?= $NNL->site('token_vcb') ?>" placeholder="Nhập token ví vcb">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputEmail1">Token ACB</label>
                                            <input type="text" class="form-control" name="token_acb" value="<?= $NNL->site('token_acb') ?>" placeholder="Nhập token ví acb">
                                        </div>
										<div class="form-group">
                                            <label for="exampleInputEmail1">Token MBBANK</label>
                                            <input type="text" class="form-control" name="token_mbbank" value="<?= $NNL->site('token_mbbank') ?>" placeholder="Nhập token ví mbbank">
                                        </div>
                                        <div class="form-group">
