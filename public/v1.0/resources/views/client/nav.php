			...
			<div class="navbar-content scroll-div ">
				<div class="">
					<div class="main-menu-header">
						...
						<div class="user-details">
							...
							<div id="more-details">API active: <?=date("d-m-Y", $getUser['time_momo'])?></div>
						</div>
					</div>
				</div>
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu">
						...
						<ul class="pcoded-submenu">
							...
							<li><a href="<?=BASE_URL('client/listacb')?>">ACB</a></li>
							<li><a href="<?=BASE_URL('client/listvcb')?>">Vietcombank</a></li>
							<li><a href="<?=BASE_URL('client/list-mbbank')?>">Mbbank</a></li>
				...
				<div class="card text-center">
					<div class="card-block">
						...
						<h6 class="mt-3">YU.COM.VN</h6>

						<a href="https://yu.com.vn/" target="_blank" class="btn btn-primary btn-sm text-white m-0">XEM NGAY</a>
					</div>
				</div>
			</div>
		</div>
	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
		<div class="m-header">
			...
			<a href="<?=BASE_URL('')?>" class="b-brand">
				...
				<img src="<?=BASE_URL('')?>public/assets/images/logo_light.png" width="150px" alt="" class="logo">
				<img src="<?=BASE_URL('')?>public/assets/images/logo_light.png" alt="" class="logo-thumb">
			</a>
